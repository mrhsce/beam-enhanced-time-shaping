...
# Main execution
scenarios = [
        # {'prefix': 'Digital-GREEDY-BITRATE_MAXIMIZATION-10000,4,5,20', 'name': 'D-BM'},
        # {'prefix': 'Digital-GREEDY-BITRATE_MAXIMIZATION-sub-allocation-10000,4,5,20', 'name': 'D-BM-S'},
        {'prefix': 'Digital-GREEDY-QUEUE_AWARE_PF_MAXIMIZATION-10000,4,5,20', 'name': 'D-QPFM'},
        {'prefix': 'Digital-GREEDY-QUEUE_AWARE_PF_MAXIMIZATION-sub-allocation-10000,4,5,20', 'name': 'D-QPFM-S'},
        {'prefix': 'Digital-GREEDY-QUEUE_LENGTH_MINIMIZATION-10000,4,5,20', 'name': 'D-QLM'},
        {'prefix': 'Digital-GREEDY-QUEUE_LENGTH_MINIMIZATION-sub-allocation-10000,4,5,20', 'name': 'D-QLM-S'},
        # {'prefix': 'Hybrid-GREEDY-BITRATE_MAXIMIZATION-10000,4,5,20', 'name': 'H-BM'},
        # {'prefix': 'Hybrid-GREEDY-BITRATE_MAXIMIZATION-sub-allocation-10000,4,5,20', 'name': 'H-BM-S'},
        # {'prefix': 'Hybrid-GREEDY-BITRATE_MAXIMIZATION-sub-allocation-30000,4,5,20', 'name': 'H-BM'},
        {'prefix': 'Hybrid-GREEDY-QUEUE_AWARE_PF_MAXIMIZATION-10000,4,5,20', 'name': 'H-QPFM'},
        {'prefix': 'Hybrid-GREEDY-QUEUE_AWARE_PF_MAXIMIZATION-sub-allocation-10000,4,5,20', 'name': 'H-QPFM-S'},
        {'prefix': 'Hybrid-GREEDY-QUEUE_LENGTH_MINIMIZATION-10000,4,5,20', 'name': 'H-QLM'},
        {'prefix': 'Hybrid-GREEDY-QUEUE_LENGTH_MINIMIZATION-sub-allocation-10000,4,5,20', 'name': 'H-QLM-S'},
    ]

directory = 'output'  # Directory where the JSON files are stored

plot_data(scenarios, directory, show_values=True, q1_q3_filter=False)
