...
def plot_data(scenarios, directory, show_values=False, q1_q3_filter=False):
    data_types = ["delays", "jitters", "queues"]
    units = {
        "delays": "ms",
        "jitters": "ms",
    }
...
# Main execution
scenarios = [
    {'prefix': 'Hybrid-GREEDY-QUEUE_AWARE_PF_MAXIMIZATION-10000,4,5,20', 'name': 'H-QPFM'},
    {'prefix': 'Hybrid-GREEDY-QUEUE_AWARE_PF_MAXIMIZATION-sub-allocation-10000,16,5,80', 'name': 'H-QPFM-M'},
    {'prefix': 'Hybrid-GREEDY-QUEUE_AWARE_PF_MAXIMIZATION-sub-allocation-10000,2,5,10', 'name': 'H-QPFM-M'},
    {'prefix': 'Hybrid-GREEDY-QUEUE_AWARE_PF_MAXIMIZATION-sub-allocation-10000,4,16,64', 'name': 'H-QPFM-M'},
    {'prefix': 'Hybrid-GREEDY-QUEUE_AWARE_PF_MAXIMIZATION-sub-allocation-10000,4,2,8', 'name': 'H-QPFM-M'},
    {'prefix': 'Hybrid-GREEDY-QUEUE_AWARE_PF_MAXIMIZATION-sub-allocation-10000,4,32,128', 'name': 'H-QPFM-M'},
    {'prefix': 'Hybrid-GREEDY-QUEUE_AWARE_PF_MAXIMIZATION-sub-allocation-10000,4,5,20', 'name': 'H-QPFM-M'},
    {'prefix': 'Hybrid-GREEDY-QUEUE_AWARE_PF_MAXIMIZATION-sub-allocation-10000,4,8,32', 'name': 'H-QPFM-M'},
    {'prefix': 'Hybrid-GREEDY-QUEUE_AWARE_PF_MAXIMIZATION-sub-allocation-10000,8,5,40', 'name': 'H-QPFM-M'},
]

scenario_rfc_count = [
    {'prefix': 'Hybrid-GREEDY-QUEUE_AWARE_PF_MAXIMIZATION-sub-allocation-10000,4,2,8', 'name': 'H-QPFM-M(2)'},
    {'prefix': 'Hybrid-GREEDY-QUEUE_AWARE_PF_MAXIMIZATION-sub-allocation-10000,4,5,20', 'name': 'H-QPFM-M(5)'},
    {'prefix': 'Hybrid-GREEDY-QUEUE_AWARE_PF_MAXIMIZATION-sub-allocation-10000,4,8,32', 'name': 'H-QPFM-M(8)'},
    {'prefix': 'Hybrid-GREEDY-QUEUE_AWARE_PF_MAXIMIZATION-sub-allocation-10000,4,16,64', 'name': 'H-QPFM-M(16)'},
    {'prefix': 'Hybrid-GREEDY-QUEUE_AWARE_PF_MAXIMIZATION-sub-allocation-10000,4,32,128', 'name': 'H-QPFM-M(32)'},
]

scenario_bs_count = [
    {'prefix': 'Hybrid-GREEDY-QUEUE_AWARE_PF_MAXIMIZATION-sub-allocation-10000,2,5,10', 'name': 'H-QPFM-M(2)'},
    {'prefix': 'Hybrid-GREEDY-QUEUE_AWARE_PF_MAXIMIZATION-sub-allocation-10000,4,5,20', 'name': 'H-QPFM-M(4)'},
    {'prefix': 'Hybrid-GREEDY-QUEUE_AWARE_PF_MAXIMIZATION-sub-allocation-10000,8,5,40', 'name': 'H-QPFM-M(8)'},
    {'prefix': 'Hybrid-GREEDY-QUEUE_AWARE_PF_MAXIMIZATION-sub-allocation-10000,16,5,80', 'name': 'H-QPFM-M(16)'},
]

directory = 'output'  # Directory where the JSON files are stored

plot_data(scenario_bs_count, directory, show_values=True, q1_q3_filter=False)
